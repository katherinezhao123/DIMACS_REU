#!/bin/bash
#SBATCH --job-name=benchmark-lora-test12-liquidai
...
lm_eval --model hf \
    --model_args pretrained=LiquidAI/LFM2.5-8B-A1B-Base,peft=/cache/home/kz498/Research/Train/lora/liquidai/test12/model,tokenizer=LiquidAI/LFM2.5-8B-A1B-Base \
    --tasks gsm8k \
    --batch_size 4 \
    --num_fewshot 8 \
    --seed $SLURM_JOB_ID \
