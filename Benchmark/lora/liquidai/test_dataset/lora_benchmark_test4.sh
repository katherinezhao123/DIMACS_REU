#!/bin/bash
#SBATCH --job-name=benchmark-lora-test4
#SBATCH --partition=gpu-redhat
#SBATCH --gres=gpu:4
#SBATCH --mem=64G
#SBATCH --time=12:00:00
#SBATCH --account=general
#SBATCH --output=test4/lora_out.txt
#SBATCH --error=test4/lora_err.txt
...
lm_eval --model hf \
    --model_args pretrained=LiquidAI/LFM2.5-8B-A1B-Base,peft=/cache/home/kz498/Research/Train/lora/test4/model,tokenizer=LiquidAI/LFM2.5-8B-A1B-Base \
    --tasks gsm8k \
    --batch_size 4 \
    --num_fewshot 8 \
    --seed $SLURM_JOB_ID \
