#!/bin/bash
#SBATCH --job-name=lora_val_benchmark_liquidai_test12
...
lm_eval --model hf \
    --model_args pretrained=LiquidAI/LFM2.5-1.2B-Instruct,peft=/cache/home/kz498/Research/Train/lora/liquidai/lora_val/test12/model,tokenizer=LiquidAI/LFM2.5-1.2B-Instruct \
    --tasks gsm8k \
    --batch_size 4 \
    --num_fewshot 8 \
    --seed $SLURM_JOB_ID \
