#!/bin/bash
#SBATCH --job-name=benchmark-lora-test6-train
#SBATCH --partition=gpu-redhat
#SBATCH --gres=gpu:4
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --account=general
#SBATCH --output=test6/lora_out.txt
#SBATCH --error=test6/lora_err.txt
...
lm_eval --model hf \
    --model_args pretrained=LiquidAI/LFM2.5-8B-A1B-Base,peft=/cache/home/kz498/Research/Train/lora/test6/model,tokenizer=LiquidAI/LFM2.5-8B-A1B-Base \
    --tasks gsm8k_train \
