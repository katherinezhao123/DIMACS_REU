#!/bin/bash
#SBATCH --job-name=benchmark-lora-test3-qwen3
...
lm_eval --model hf \
    --model_args pretrained=Qwen/Qwen3-8B-Base,peft=/cache/home/kz498/Research/Train/lora/qwen3/test3/model,tokenizer=Qwen/Qwen3-8B-Base \
    --tasks gsm8k \
    --batch_size 4 \
    --num_fewshot 8 \
    --seed $SLURM_JOB_ID \
