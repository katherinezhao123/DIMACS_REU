#!/bin/bash
#SBATCH --job-name=benchmark-lorta-test4-llama2
...
lm_eval --model hf \
    --model_args pretrained=meta-llama/Llama-2-7b-hf,peft=/cache/home/kz498/Research/Train/lorta/llama2/test4/model,tokenizer=meta-llama/Llama-2-7b-hf \
    --tasks gsm8k \
    --batch_size 1 \
    --num_fewshot 8 \
    --seed $SLURM_JOB_ID \
