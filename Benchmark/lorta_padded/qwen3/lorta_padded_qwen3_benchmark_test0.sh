#!/bin/bash
#SBATCH --job-name=benchmark-lorta-padded-test0-qwen3
...
lm_eval --model hf \
    --model_args pretrained=Qwen/Qwen3-8B-Base,peft=/cache/home/kz498/Research/Train/lorta_padded/qwen3/test0/model,tokenizer=Qwen/Qwen3-8B-Base \
    --tasks gsm8k \
    --batch_size 1 \
    --num_fewshot 8 \
    --seed $SLURM_JOB_ID \
