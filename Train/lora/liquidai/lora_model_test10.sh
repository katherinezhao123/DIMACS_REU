#!/bin/bash
#SBATCH --job-name=lora-finetune-test10
...
#SBATCH --output=test10/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test10/lora_err.txt    # stderr separately so errors are easy to find
...
mkdir -p ./test10/model ./test10/checkpoints
...
python3 /cache/home/kz498/Research/Train/lora/lora_model.py \
        ...
        --warmup_ratio 0.06 \
        --lr_scheduler linear \
        --output_dir ./test10/checkpoints \
        --save_dir ./test10/model 
