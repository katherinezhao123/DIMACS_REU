#!/bin/bash
#SBATCH --job-name=lora-finetune-test11
...
#SBATCH --output=test11/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test11/lora_err.txt    # stderr separately so errors are easy to find
...
mkdir -p ./test11/model ./test11/checkpoints
...
python3 /cache/home/kz498/Research/Train/lora/lora_model.py \
        ...
        --warmup_ratio 0.06 \
        --lr_scheduler linear \
        --output_dir ./test11/checkpoints \
        --save_dir ./test11/model 
