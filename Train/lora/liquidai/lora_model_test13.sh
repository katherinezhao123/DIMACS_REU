#!/bin/bash
#SBATCH --job-name=lora-finetune-test13
...
#SBATCH --output=test13/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test13/lora_err.txt    # stderr separately so errors are easy to find
...
mkdir -p ./test13/model ./test13/checkpoints
...
python3 /cache/home/kz498/Research/Train/lora/lora_model.py \
        ...
        --warmup_ratio 0.06 \
        --lr_scheduler linear \
        --output_dir ./test13/checkpoints \
        --save_dir ./test13/model 
