#!/bin/bash
#SBATCH --job-name=lora-finetune-test14
...
#SBATCH --output=test14/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test14/lora_err.txt    # stderr separately so errors are easy to find
...
mkdir -p ./test14/model ./test14/checkpoints
...
python3 /cache/home/kz498/Research/Train/lora/lora_model.py \
        ...
        --warmup_ratio 0.1 \
        --lr_scheduler linear \
        --output_dir ./test14/checkpoints \
        --save_dir ./test14/model 
