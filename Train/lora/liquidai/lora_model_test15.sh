#!/bin/bash
#SBATCH --job-name=lora-finetune-test15
...
#SBATCH --output=test15/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test15/lora_err.txt    # stderr separately so errors are easy to find
...
mkdir -p ./test15/model ./test15/checkpoints
...
python3 /cache/home/kz498/Research/Train/lora/lora_model.py \
        ...
        --warmup_ratio 0.1 \
        --lr_scheduler linear \
        --output_dir ./test15/checkpoints \
        --save_dir ./test15/model 
