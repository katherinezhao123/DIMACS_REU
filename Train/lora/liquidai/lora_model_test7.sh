#!/bin/bash
#SBATCH --job-name=lora-finetune-test7
...
#SBATCH --output=test7/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test7/lora_err.txt    # stderr separately so errors are easy to find
