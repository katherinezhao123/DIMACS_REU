#!/bin/bash
#SBATCH --job-name=lora-finetune-test8
...
#SBATCH --output=test8/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test8/lora_err.txt    # stderr separately so errors are easy to find
