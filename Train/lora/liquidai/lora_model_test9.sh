#!/bin/bash
#SBATCH --job-name=lora-finetune-test9
...
#SBATCH --output=test9/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test9/lora_err.txt    # stderr separately so errors are easy to find
...
mkdir -p ./test9/model ./test9/checkpoints
...
python3 /cache/home/kz498/Research/Train/lora/lora_model.py \
        ...
        --lr_scheduler linear \
        --warmup_ratio 0.06 \
        --output_dir ./test9/checkpoints \
        --save_dir ./test9/model 
