#!/bin/bash
#SBATCH --job-name=lora-val-llama2-test4
...
#SBATCH --output=test4/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test4/lora_err.txt    # stderr separately so errors are easy to find
...
START=$(date +%s)
python3 /cache/home/kz498/Research/Train/lora/llama2/llama2_val/lora_val_llama2.py \
        --r 8 \
        --lora_alpha 16 \
        --lr 5e-4 \
        --num_train_epochs 4 \
