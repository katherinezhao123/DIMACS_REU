#!/bin/bash
#SBATCH --job-name=lora-llama2-test2
...
#SBATCH --output=test2/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test2/lora_err.txt    # stderr separately so errors are easy to find
