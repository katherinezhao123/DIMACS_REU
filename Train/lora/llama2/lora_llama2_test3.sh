#!/bin/bash
#SBATCH --job-name=lora-llama2-test3
...
#SBATCH --output=test3/lora_out.txt   # stdout — %j is the job ID
#SBATCH --error=test3/lora_err.txt    # stderr separately so errors are easy to find
