...
class LorTaPaddedLayer(LoraLayer):
    ...
    def _check_forward_args(self, x, *args, **kwargs):
        ...
        if dW is None:
            msg = "LorTa Padded receives adapter weights from the parent class."
...
class Linear(nn.Module, LorTaPaddedLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        LorTaPaddedLayer.__init__(self, base_layer, **kwargs)
    ...
    def forward(self, x: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        if dW is None:
            raise ValueError("LorTa Padded receives adapter weights from the parent class.")
    ...
    def __repr__(self) -> str:
        rep = super().__repr__()
        return "lorta padded." + rep


class Embedding(nn.Module, LorTaPaddedLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        LorTaPaddedLayer.__init__(self, base_layer)
        raise NotImplementedError
...
class Conv2d(nn.Module, LorTaPaddedLayer):
    ...
    def forward(self, x: torch.Tensor, *args, **kwargs) -> torch.Tensor:
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                dW = kwargs.get("adapter_weight", None)
                if dW is None:
                    raise ValueError("LorTaPadded receives adapter weights from the parent class.")
                dropout = self.lora_dropout[active_adapter]
                scaling = self.scaling[active_adapter]
                x = x.to(dW.dtype)
